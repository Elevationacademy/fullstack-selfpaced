...
-   Create a new table - "Dolphin" with the following columns:
    ...
    -   `healthy` - this is a boolean value. Use PostgreSQL's `BOOLEAN` type and **give them a value of** **`true`**  [**by default**](https://www.postgresql.org/docs/current/ddl-default.html)
