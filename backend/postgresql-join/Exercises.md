...
-   The **only** auto-incrementing PK should be in the `patient` table (use `SERIAL`)
...
Read the [documentation for the](https://www.postgresql.org/docs/current/functions-aggregate.html) [COUNT](https://www.postgresql.org/docs/current/functions-aggregate.html) [command](https://www.postgresql.org/docs/current/functions-aggregate.html).
...
Read the [documentation for the](https://www.postgresql.org/docs/current/queries-table-expressions.html#QUERIES-GROUP) [GROUP BY](https://www.postgresql.org/docs/current/queries-table-expressions.html#QUERIES-GROUP) [command](https://www.postgresql.org/docs/current/queries-table-expressions.html#QUERIES-GROUP).
