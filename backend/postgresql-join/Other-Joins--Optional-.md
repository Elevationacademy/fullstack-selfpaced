...
If you're interested in SQL, there's a whole [world of](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-inner-join/) [join](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-inner-join/)[ing](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-inner-join/) that doesn't use the `WHERE` keyword at all, but has the same principle.
